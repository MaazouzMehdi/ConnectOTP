...
BEGIN
	...
	select count(*) from streetnetwork_vertices_pgr into noVertices;
	FOR i in 1..noCombinations LOOP
		 ...
		 INSERT INTO optstart ( select * from streetnetwork_vertices_pgr where id = startVertice );
		 ...
		 INSERT INTO opttarget ( select * from streetnetwork_vertices_pgr where id = targetVertice );
